                    ...
                    <div className="space-y-3">
                        {providers.map((provider) => (
                            <button
                                ...
                                className={`w-full flex items-center justify-center gap-3 px-4 py-3 bg-gradient-to-r ${provider.color} text-white font-medium rounded-xl transition-all duration-200 shadow-lg hover:shadow-xl hover:scale-[1.02] active:scale-[0.98]`}
                            >
                                {provider.icon}
