    ...
    return (
        <div className="relative">
            <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-400 hover:to-blue-500 text-white font-medium rounded-lg transition-all duration-200 shadow-lg shadow-cyan-500/25 hover:shadow-cyan-500/40"
            >
            ...
            {isOpen && (
                <>
                    ...
                    <div className="absolute right-0 mt-2 w-56 bg-slate-800/95 backdrop-blur-xl border border-slate-700/50 rounded-xl shadow-2xl z-50 overflow-hidden">
                        <div className="p-2">
                            <p className="px-3 py-2 text-xs text-slate-400 uppercase tracking-wider font-medium">
                                Choose Provider
                            </p>
                            {providers.map((provider) => (
                                <button
                                    ...
                                    className="w-full flex items-center gap-3 px-3 py-2.5 text-slate-200 hover:bg-slate-700/50 rounded-lg transition-colors"
                                >
                                    {provider.icon}
